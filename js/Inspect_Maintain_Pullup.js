...
function pullupRefresh() {
	setTimeout(function() {
		...
		function WebApp_ExamineWorkTask_Emm1(UnitCode, Status, PageIndex, PageSize) {
			var url = 'http://' + localStorage.getItem("serverAddress") + ':' + localStorage.getItem("portNum") + '/WebApi/DataExchange/GetData/WebApp_ExamineWorkTask_Emm?dataKey=00-00-00-00&OrganiseUnitCode=' + UnitCode + '&Status=' + Status + '&PageIndex=' + PageIndex + '&PageSize=' + PageSize;
			console.log(url);
...
//					}
					...
					mui.each(getDatas, function(index, item) {
						...
						html1 +=
							...
							'<p style="font-size:0.85rem;width:100%;">' + item.TaskName + '</p>' +
							'<p style="font-size:0.7rem;color:#666666;width:100%;">检修单位：' + item.TaskName + '</p>' +
		...
		WebApp_ExamineWorkTask_Emm1(localStorage.getItem('OrganiseUnitCode'), Status[0], ++count1, PageSize);

		function WebApp_ExamineWorkTask_Emm2(UnitCode, Status, PageIndex, PageSize) {
			var url = 'http://' + localStorage.getItem("serverAddress") + ':' + localStorage.getItem("portNum") + '/WebApi/DataExchange/GetData/WebApp_ExamineWorkTask_Emm?dataKey=00-00-00-00&OrganiseUnitCode=' + UnitCode + '&Status=' + Status + '&PageIndex=' + PageIndex + '&PageSize=' + PageSize;
			console.log(url);
...
//					}
		...
		WebApp_ExamineWorkTask_Emm2(localStorage.getItem('OrganiseUnitCode'), Status[1], ++count2, PageSize);

		function WebApp_ExamineWorkTask_Emm3(UnitCode, Status, PageIndex, PageSize) {
			var url = 'http://' + localStorage.getItem("serverAddress") + ':' + localStorage.getItem("portNum") + '/WebApi/DataExchange/GetData/WebApp_ExamineWorkTask_Emm?dataKey=00-00-00-00&OrganiseUnitCode=' + UnitCode + '&Status=' + Status + '&PageIndex=' + PageIndex + '&PageSize=' + PageSize;
			console.log(url);
...
//					}
		...
		WebApp_ExamineWorkTask_Emm3(localStorage.getItem('OrganiseUnitCode'), Status[2], ++count3, PageSize);
