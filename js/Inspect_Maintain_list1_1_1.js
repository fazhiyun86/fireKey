...
//	var IndicatorID = self.IndicatorID;
	...
	function WebApp_GetEMMObject(Id) {
		var urlTask = 'http://' + localStorage.getItem("serverAddress") + ':' + localStorage.getItem("portNum") + '/WebApi/DataExchange/GetData/WebApp_GetEMMObject?dataKey=00-00-00-00&TaskGroupID=' + Id;
		console.log(urlTask);
		mui.ajax(urlTask, {
			data: null,
			dataType: 'json', //返回
...
//					console.log(item.IsNormal+item.EquipmentCode) 
	...
	WebApp_GetEMMObject(TaskGroupID);
